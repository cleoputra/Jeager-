                ...
                <div className="container">
                    <div className="row">
                        <div className="col-12">
                            <img src={require('../assets/logohitam.png')} height="100%" width="80%" alt="Logo Footer"/>
                        </div>
                ...
                <div className="container mt-3">
                    <div className="row">
                        ...
                        <div className="col-6 px-0 d-flex align-items-center justify-content-center">
                            <img src={require('../assets/ig.png')} width="20%"/>
                            <img src={require('../assets/fb.png')} width="20%"/>
                            <img src={require('../assets/twitter.png')} width="20%"/>
                        </div>
                    </div>
                </div>
            </div>
